<template>
	<view>
		<cu-custom bgColor="bg-red" :isBack="true"><block slot="backText">返回</block><block slot="content">隐患归档</block></cu-custom>
		...
		<view class="cu-form-group" v-if="secondFoo.position">
