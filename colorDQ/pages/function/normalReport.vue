<template>
	<view id='yhsb'>
		...
		<view class="cu-form-group" id="sss">
			...
			<switch class='switch-sex red sss' @change="changeType" :class="isDanger?'checked':''" :checked="isDanger?true:false" color="#e54d42" style="font-size: 20upx;"></switch>
		</view>
...
<script>
	export default {
		...
		mounted() {
			// this.yscd = this._props.yscd;
			// this.name = this._props.name;
			// this.firstLevelId = this._props.firstlevel;
			console.log(this.yscd,this._props)
			this.getLocation()
			this.getPCYD();
			this.getDescription()
		}
