<template>
	<view id="xg">
		<view style="margin-bottom: 200upx;">
			<view v-for="(item, index) in xgData" :key="index">
				...
				>
					<view class="grid col-4 grid-square flex-sub">
						<view class="bg-img" v-for="(photo, photoindex) in imgrow[index].url" :key="photoindex" @tap="ViewImage" :data-url="imgrow[index].url[photoindex]" :data-index="index">
			...
			<view class="padding flex flex-direction margin-top"><button class="cu-btn bg-red margin-tb-sm lg" @click="nextStep" :disabled="disabled">提交</button></view>
		</view>
	</view>
</template>
