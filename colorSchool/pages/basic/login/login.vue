<template>
	<view>
		...
		<view class="login-title bg-olive">
			校园安全隐患排查
		</view>
		...
		<view class="login-commit">
			<button class="cu-btn bg-olive commit-btn" @click="commit">{{loginWay}}</button>
		</view>
		...
		<view class="wx-icon-r">
			<view class="wx-icon-row">
				<image :src="wxImage" mode="aspectFit" class="wx-icon" @click="loginByWechat"></image>
			</view>
		</view>
