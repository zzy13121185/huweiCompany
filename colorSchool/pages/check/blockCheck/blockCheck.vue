...
export default {
	...
	methods: {
		...
		showDetail(e) {
			console.log(e);
			uni.navigateTo({
				url: 'BCdetail/BCdetail?placeNo=' + e.currentTarget.dataset.info.placeNo + '&time=' + e.currentTarget.dataset.info.checkTime
			});
		},
		hideModal(e) {
			this.modalName = null;
