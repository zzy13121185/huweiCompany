	...
	<view id='yhsb'>
		...
		<view style="position: relative;margin-top: 120upx;">
			<view v-if="TabCur == 0">
				...
				<normal :yscd="yscd" :name="name" :firstLevelId="firstLevelId"></normal>
			</view>
			<view v-if="TabCur == 1">
				<scene :yscd="yscd" :name="name" :firstLevelId="firstLevelId"></scene>
			</view>
		</view>
...
<script>
	import normal from '../../function/normal.vue';
	import scene from '../../function/scene.vue';
	export default {
		components: {
			normal,
			scene
